...
serve(async (req) => {
  ...
  try {
    ...
    const stylePrompts: Record<string, { male: string; female: string }> = {
      ...
      swimwear: {
        female: "in a luxury fashion editorial beach photoshoot, wearing a flattering coordinated two-piece bikini set — a structured bikini top with adjustable straps and matching high-cut bikini bottoms in a rich solid color or elegant print. The bikini top and bottom are clearly visible as separate coordinated pieces. CRITICAL: Do NOT add any sarong, pareo, wrap, cover-up, kaftan, robe, towel, shirt, or any fabric draped over the bikini or body. The bare midriff, stomach, hips, legs, and shoulders must be fully visible — show the user's actual skin uncovered. Styled ONLY with strappy flat sandals, oversized designer sunglasses, and delicate gold layered body chains (no fabric accessories). Beautiful tropical beach resort setting with turquoise water and palm trees. Professional fashion magazine editorial photography, golden-hour lighting, full body shot showing the complete swimwear look with skin visible.",
