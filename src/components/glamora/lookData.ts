...
export const lookData: Record<string, Partial<Record<Category, Step[]>>> = {
  "Soft Glam": {
    ...
    top: [
      ...
      { title: "Mid Layer", detail: "Layer with a tailored blazer in dusty rose, camel, or soft beige. Opt for relaxed shoulders.", shop: { luxury: { store: "Nordstrom", item: "Stella McCartney Oversized Blazer", price: "$1,495" }, mid: { store: "Zara", item: "Double-Breasted Blazer in Dusty Pink", price: "$90" }, budget: { store: "Amazon", item: "Lapel Collar Single Button Blazer", price: "$28" } } },
    ...
    bottom: [
      { title: "Trousers", detail: "High-waisted wide-leg trousers in cream, tan, or soft grey. Clean lines complement the softness.", tip: "A crease down the front adds polish", shop: { luxury: { store: "Net-a-Porter", item: "The Row Gala Wide-Leg Pants", price: "$890" }, mid: { store: "Nordstrom", item: "Effortless Wide-Leg Pant", price: "$110" }, budget: { store: "H&M", item: "Wide-Leg Dress Pants", price: "$30" } } },
  ...
  "Gym Power": {
    top: [
      { title: "Stringer Tank", detail: "Deep-cut stringer or Y-back tank.", shop: { luxury: { store: "Nike", item: "Gymshark Legacy Stringer", price: "$30" }, mid: { store: "Under Armour", item: "UA Project Rock Payoff Tank", price: "$35" }, budget: { store: "Amazon", item: "Muscle Killer Y-Back Stringer 3pk", price: "$24" } } },
      { title: "Oversized Gym Tee", detail: "Dropped shoulder oversized tee, breathable cotton-blend.", shop: { luxury: { store: "Nike", item: "Gymshark Power Oversized T-Shirt", price: "$38" }, mid: { store: "Nike", item: "Nike Dri-FIT Hyverse Tee", price: "$40" }, budget: { store: "Amazon", item: "Champion Men's Classic Tee", price: "$12" } } },
    ],
    bottom: [
      { title: "Gym Shorts", detail: "Above-the-knee shorts with liner, 5-7\" length.", shop: { luxury: { store: "Nike", item: "Gymshark Arrival 5\" Shorts", price: "$35" }, mid: { store: "Under Armour", item: "UA Launch Run 5\" Shorts", price: "$40" }, budget: { store: "Amazon", item: "MIER Men's 5\" Workout Shorts", price: "$18" } } },
      { title: "Tapered Joggers", detail: "Slim-fit joggers with zippered ankles.", shop: { luxury: { store: "Nike", item: "Gymshark Crest Joggers", price: "$50" }, mid: { store: "Nike", item: "Nike Dri-FIT Taper Fleece Pants", price: "$55" }, budget: { store: "Amazon", item: "BROKIG Slim Fit Joggers", price: "$28" } } },
    ],
    shoes: [
...
export const shoeLookData: Record<string, Step[]> = {
  "Shoe Edit": [
    ...
    { title: "Running Sneakers", detail: "Performance-meets-style runners — Nike Air Max 90, Asics Gel-Kayano 14, Adidas Ultra Boost, or On Cloud. Tech fabrics and cushioned soles.", shop: { luxury: { store: "Nordstrom", item: "Salomon XT-6 Advanced", price: "$195" }, mid: { store: "Nike", item: "Nike Air Max 90", price: "$130" }, budget: { store: "Adidas", item: "Adidas Ultraboost 1.0", price: "$95" } } },
