...
export const lookData: Record<string, Partial<Record<Category, Step[]>>> = {
  "Soft Glam": {
    ...
    top: [
      ...
      { title: "Mid Layer", detail: "Layer with a tailored blazer in dusty rose, camel, or soft beige. Opt for relaxed shoulders.", shop: { luxury: { store: "Nordstrom", item: "Vince Relaxed Blazer", price: "$1,495" }, mid: { store: "Zara", item: "Double-Breasted Blazer in Dusty Pink", price: "$90" }, budget: { store: "Amazon", item: "Floerns Women's Single Button Blazer", price: "$28" } } },
    ...
    bottom: [
      { title: "Trousers", detail: "High-waisted wide-leg trousers in cream, tan, or soft grey. Clean lines complement the softness.", tip: "A crease down the front adds polish", shop: { luxury: { store: "Net-a-Porter", item: "The Row Gala Wide-Leg Pants", price: "$890" }, mid: { store: "Nordstrom", item: "Vince Pleat Front Wide Leg Pants", price: "$110" }, budget: { store: "H&M", item: "Wide-Leg Dress Pants", price: "$30" } } },
  ...
  "Berry Chic": {
    makeup: [
      ...
      { title: "Bold Berry Lip", detail: "Line with a deep berry liner. Fill with a matte berry or plum lipstick. Blot and reapply for intensity.", videoUrl: "https://www.youtube.com/results?search_query=how+to+apply+bold+dark+lipstick+beginner", videoLabel: "Bold Lip Application", shop: { luxury: { store: "Nordstrom", item: "YSL Tatouage Couture in Berry Cult", price: "$40" }, mid: { store: "MAC", item: "MAC Retro Matte in Flat Out Fabulous", price: "$22" }, budget: { store: "Target", item: "NYX Suede Matte in Girl, Bye", price: "$8" } } },
    ],
    top: [
    ...
    bottom: [
      { title: "Tailored Pants", detail: "Black high-waisted cigarette trousers or tailored straight-leg pants.", shop: { luxury: { store: "Nordstrom", item: "Theory Demitria Good Wool Trousers", price: "$295" }, mid: { store: "Nordstrom", item: "Babaton Cohen Pant in Black", price: "$120" }, budget: { store: "H&M", item: "Slim-Fit Tailored Trousers", price: "$28" } } },
  ...
  "Urban Edge": {
    ...
    bottom: [
      { title: "Cargo Pants", detail: "Relaxed-fit cargo pants in black, olive, or khaki. Multiple pockets are key.", shop: { luxury: { store: "Nordstrom", item: "Stone Island Cargo Pants", price: "$425" }, mid: { store: "Urban Outfitters", item: "BDG Y2K Low-Rise Cargo Pant", price: "$59" }, budget: { store: "Amazon", item: "Match Men's Wild Cargo Pants", price: "$28" } } },
    ...
    accessories: [
      { title: "Cap", detail: "A fitted or snapback cap. Dad hats in neutral tones or branded caps.", shop: { luxury: { store: "Nordstrom", item: "Acne Studios Logo Cap", price: "$150" }, mid: { store: "Urban Outfitters", item: "New Era 9FORTY Cap", price: "$30" }, budget: { store: "Amazon", item: "Nike Heritage86 Cap", price: "$18" } } },
  ...
  "Sport Luxe": {
    ...
    top: [
      ...
      { title: "Track Jacket", detail: "A zip-up track jacket with contrast piping or a cropped puffer. Sporty but elevated.", shop: { luxury: { store: "Nordstrom", item: "Adidas x Wales Bonner Track Jacket", price: "$350" }, mid: { store: "Adidas", item: "Adidas Originals Firebird Track Jacket", price: "$80" }, budget: { store: "Amazon", item: "Amazon Essentials Full-Zip Track Jacket", price: "$22" } } },
  ...
  "MMA Fighter": {
    top: [
      { title: "Rash Guard", detail: "Compression rash guard for grappling and striking.", shop: { luxury: { store: "Amazon", item: "Venum Contender 6.0 Rash Guard", price: "$65" }, mid: { store: "Amazon", item: "Hayabusa Arrow Rash Guard", price: "$55" }, budget: { store: "Amazon", item: "TSLA Men's UPF 50+ Rash Guard", price: "$20" } } },
      { title: "Fight Shorts", detail: "Flexible MMA fight shorts with side slits for kicks.", shop: { luxury: { store: "Amazon", item: "Venum UFC Pro Line Fight Shorts", price: "$90" }, mid: { store: "Amazon", item: "Hayabusa Hex Fight Shorts", price: "$60" }, budget: { store: "Amazon", item: "Sanabul Essential MMA Shorts", price: "$22" } } },
    ],
    bottom: [
      { title: "Compression Pants", detail: "Full-length compression tights under fight shorts.", shop: { luxury: { store: "Amazon", item: "Venum Contender 6.0 Compression Pants", price: "$55" }, mid: { store: "Under Armour", item: "UA HeatGear Compression Legging", price: "$40" }, budget: { store: "Amazon", item: "Tesla Men's Compression Pants", price: "$18" } } },
    ],
    shoes: [
    ...
    accessories: [
      { title: "Boxing Gloves", detail: "12-16oz boxing gloves for bag work and sparring.", shop: { luxury: { store: "Amazon", item: "Hayabusa T3 Boxing Gloves 16oz", price: "$160" }, mid: { store: "Amazon", item: "Venum Challenger 3.0 Gloves", price: "$55" }, budget: { store: "Amazon", item: "Everlast Pro Style Training Gloves", price: "$25" } } },
      { title: "MMA Gloves", detail: "4oz competition or 7oz sparring MMA gloves.", shop: { luxury: { store: "Amazon", item: "Hayabusa T3 MMA Gloves", price: "$100" }, mid: { store: "Amazon", item: "Venum Challenger 3.0 MMA Gloves", price: "$40" }, budget: { store: "Amazon", item: "Liberlupus MMA Gloves", price: "$18" } } },
      { title: "Hand Wraps", detail: "180\" hand wraps for wrist and knuckle protection.", shop: { luxury: { store: "Amazon", item: "Hayabusa Perfect Stretch Hand Wraps", price: "$20" }, mid: { store: "Amazon", item: "Venum Kontact Hand Wraps", price: "$12" }, budget: { store: "Amazon", item: "Sanabul Elastic Hand Wraps", price: "$8" } } },
      { title: "Shin Guards", detail: "Padded shin guards for Muay Thai and MMA sparring.", shop: { luxury: { store: "Amazon", item: "Hayabusa T3 Shin Guards", price: "$100" }, mid: { store: "Amazon", item: "Venum Challenger Shin Guards", price: "$45" }, budget: { store: "Amazon", item: "Sanabul Essential Shin Guards", price: "$22" } } },
    ],
  },
  "CrossFit Beast": {
    top: [
    ...
    accessories: [
      { title: "Weightlifting Belt", detail: "Nylon or leather lifting belt.", shop: { luxury: { store: "Amazon", item: "Rogue 4\" Nylon Lifting Belt", price: "$35" }, mid: { store: "Amazon", item: "Dark Iron Fitness Leather Belt", price: "$30" }, budget: { store: "Amazon", item: "Gymreapers Quick Locking Belt", price: "$22" } } },
      { title: "Hand Grips", detail: "Leather grips for pull-ups and bar work.", shop: { luxury: { store: "Amazon", item: "Rogue V2 Gymnastics Grips", price: "$35" }, mid: { store: "Amazon", item: "Bear KompleX Carbon Grips", price: "$40" }, budget: { store: "Amazon", item: "JerkFit WODies Hand Grips", price: "$20" } } },
      { title: "Knee Sleeves", detail: "7mm neoprene knee sleeves for squat support.", shop: { luxury: { store: "Amazon", item: "Rehband RX Knee Sleeves 7mm", price: "$80" }, mid: { store: "Amazon", item: "Nordic Lifting Knee Sleeves", price: "$40" }, budget: { store: "Amazon", item: "Gymreapers Knee Sleeves 5mm", price: "$25" } } },
    ],
  },
  "Gym Power": {
    top: [
      { title: "Stringer Tank", detail: "Deep-cut stringer or Y-back tank.", shop: { luxury: { store: "Nike", item: "Nike Dri-FIT Stringer Tank", price: "$30" }, mid: { store: "Under Armour", item: "UA Project Rock Payoff Tank", price: "$35" }, budget: { store: "Amazon", item: "Muscle Killer Y-Back Stringer 3pk", price: "$24" } } },
      { title: "Oversized Gym Tee", detail: "Dropped shoulder oversized tee, breathable cotton-blend.", shop: { luxury: { store: "Nike", item: "Nike Sportswear Oversized Tee", price: "$38" }, mid: { store: "Nike", item: "Nike Dri-FIT Hyverse Tee", price: "$40" }, budget: { store: "Amazon", item: "Champion Men's Classic Tee", price: "$12" } } },
    ],
    bottom: [
      { title: "Gym Shorts", detail: "Above-the-knee shorts with liner, 5-7\" length.", shop: { luxury: { store: "Nike", item: "Nike Dri-FIT Challenger 5\" Shorts", price: "$35" }, mid: { store: "Under Armour", item: "UA Launch Run 5\" Shorts", price: "$40" }, budget: { store: "Amazon", item: "MIER Men's 5\" Workout Shorts", price: "$18" } } },
      { title: "Tapered Joggers", detail: "Slim-fit joggers with zippered ankles.", shop: { luxury: { store: "Nike", item: "Nike Sportswear Tech Fleece Joggers", price: "$50" }, mid: { store: "Nike", item: "Nike Dri-FIT Taper Fleece Pants", price: "$55" }, budget: { store: "Amazon", item: "BROKIG Slim Fit Joggers", price: "$28" } } },
    ],
    shoes: [
    ...
    accessories: [
      { title: "Lifting Straps", detail: "Cotton or nylon lifting straps for heavy pulls.", shop: { luxury: { store: "Amazon", item: "Rogue Ohio Lifting Straps", price: "$22" }, mid: { store: "Amazon", item: "Harbinger Padded Lifting Straps", price: "$10" }, budget: { store: "Amazon", item: "GYMREAPERS Lifting Straps", price: "$10" } } },
      { title: "Weightlifting Belt", detail: "Leather powerlifting belt for heavy lifts.", shop: { luxury: { store: "Amazon", item: "Rogue Ohio Leather Belt 10mm", price: "$110" }, mid: { store: "Amazon", item: "Dark Iron Fitness Leather Belt", price: "$30" }, budget: { store: "Amazon", item: "Gymreapers Quick Locking Belt", price: "$22" } } },
  ...
  "Boho Bride": {
    ...
    accessories: [
      { title: "Flower Crown", detail: "Fresh or dried flower crown in whites and greenery.", shop: { luxury: { store: "Amazon", item: "Custom Fresh Flower Crown", price: "$120" }, mid: { store: "Amazon", item: "Handmade Dried Flower Crown", price: "$35" }, budget: { store: "Amazon", item: "Floral Crown Headband White Rose", price: "$12" } } },
...
export const shoeLookData: Record<string, Step[]> = {
  "Shoe Edit": [
    { title: "Retro Sneakers", detail: "Heritage silhouettes like Air Jordan 1, Nike Dunk Low, New Balance 550, or Adidas Samba. Timeless designs that pair with everything from jeans to tailored trousers.", tip: "White/neutral colorways are the most versatile", shop: { luxury: { store: "Nordstrom", item: "Golden Goose Super-Star Sneakers", price: "$530" }, mid: { store: "Nike", item: "Nike Dunk Low Retro", price: "$115" }, budget: { store: "New Balance", item: "New Balance 480 Classic", price: "$75" } } },
    { title: "Running Sneakers", detail: "Performance-meets-style runners — Nike Air Max 90, Asics Gel-Kayano 14, Adidas Ultra Boost, or On Cloud. Tech fabrics and cushioned soles.", shop: { luxury: { store: "Nike", item: "Nike Pegasus Trail 4", price: "$195" }, mid: { store: "Nike", item: "Nike Air Max 90", price: "$130" }, budget: { store: "Adidas", item: "Adidas Ultraboost 1.0", price: "$95" } } },
...
export const bagLookData: Record<string, Step[]> = {
  "Bag Edit": [
    ...
    { title: "Designer Classic", detail: "An investment piece that transcends trends — Chanel Flap, Hermès Birkin, or Dior Saddle.", tip: "Pre-owned luxury is a smart entry point", shop: { luxury: { store: "Nordstrom", item: "Chanel Classic Double Flap (Pre-owned)", price: "$6,500" }, mid: { store: "Amazon", item: "Louis Vuitton Neverfull MM (Pre-owned)", price: "$1,200" }, budget: { store: "Amazon", item: "TIBES Classic Quilted Chain Bag", price: "$25" } } },
  ],
};
