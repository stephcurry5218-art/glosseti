...
export const lookData: Record<string, Partial<Record<Category, Step[]>>> = {
  ...
  "Retro Revival": {
    makeup: [
      { title: "Retro Base", detail: "A full-coverage satin foundation for a porcelain-doll finish. Set with a finely milled powder.", videoUrl: "https://www.youtube.com/results?search_query=vintage+retro+makeup+base+tutorial+beginner", videoLabel: "Retro Satin Base Tutorial", shop: { luxury: { store: "Sephora", item: "Charlotte Tilbury Airbrush Flawless Foundation", price: "$46" }, mid: { store: "Ulta", item: "L'Oréal Infallible Pro-Matte Foundation", price: "$13" }, budget: { store: "Amazon", item: "Revlon Candid Glow Foundation", price: "$8" } } },
      ...
      { title: "Red Lip", detail: "A classic red lipstick — warm red for warm undertones, blue-red for cool.", videoUrl: "https://www.youtube.com/results?search_query=how+to+apply+red+lipstick+perfectly+beginner", videoLabel: "Perfect Red Lip Guide", shop: { luxury: { store: "Nordstrom", item: "MAC Ruby Woo Retro Matte Lipstick", price: "$22" }, mid: { store: "Ulta", item: "Revlon Super Lustrous in Certainly Red", price: "$9" }, budget: { store: "Amazon", item: "Maybelline Color Sensational in Red Revival", price: "$6" } } },
    ],
    top: [
