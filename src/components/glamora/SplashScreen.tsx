    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: "radial-gradient(circle, rgba(184,107,89,0.35) 0%, transparent 70%)",
          animation: "glamFloat 5s ease-in-out infinite",
        }}
      />
      <div
        className="absolute rounded-full"
        style={{
          ...
          background: "radial-gradient(circle, rgba(196,151,74,0.25) 0%, transparent 70%)",
          animation: "glamFloat 6s ease-in-out infinite 1s",
        }}
      />
      {/* Logo */}
      ...
      <div
        ...
        style={{
          marginTop: 60, width: 44, height: 44, borderRadius: "50%",
          border: "2px solid rgba(196,151,74,0.2)",
